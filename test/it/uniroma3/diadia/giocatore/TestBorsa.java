...
class TestBorsa {
	...
	void testAggiuntaAttrezzo2() {
		...
		boolean result = this.borsaTest.hasAttrezzo(attrezzoTest1.getNome())
				&& this.borsaTest.hasAttrezzo(attrezzoTest2.getNome());
		assertTrue(result);
	}
	...
	void testGetAttrezzo() {
		...
		// getAttrezzo non deve rimuovere l'attrezzo dalla borsa, ritorna un riferimento
		// non una copia quindi controllo con (==)
